...
import logo from "assets/image/wejelly/Logo_ACBIQ_30.png";
...
class Sidebar extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      openComponentsAnnouncement:
        this.activeRoute("/openComponentsAnnouncement") !== "" ? true : false,
  ...
  render() {
    return (
      <div>
        ...
        <div className="sidebar" data-color="jelly">
          <div className="logo">
